...
GRANT SELECT ON SPORTS_MANAGEMENT.USERS TO 'admin'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.PLAY TO 'admin'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.GAMES TO 'admin'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.TEAMS TO 'admin'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.MANAGER TO 'admin'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.STATS TO 'admin'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.PROFILE TO 'admin'@'localhost';
...
GRANT SELECT(PUSER_ID, FIRST_NAME, LAST_NAME) ON SPORTS_MANAGEMENT.PROFILE TO 'manager'@'localhost';
GRANT SELECT(USER_ID) ON SPORTS_MANAGEMENT.USERS TO 'manager'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.PLAY TO 'manager'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.GAMES TO 'manager'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.TEAMS TO 'manager'@'localhost';
GRANT SELECT(MANAGER_ID) ON SPORTS_MANAGEMENT.MANAGER TO 'manager'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.PROFILE TO 'manager'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.STATS TO 'manager'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.PLAYER TO 'manager'@'localhost';
...
GRANT SELECT ON SPORTS_MANAGEMENT.PLAY TO 'user'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.GAMES TO 'user'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.TEAMS TO 'user'@'localhost';
GRANT SELECT ON SPORTS_MANAGEMENT.STATS TO 'user'@'localhost';
