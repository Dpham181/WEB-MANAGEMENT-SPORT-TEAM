...
<html>
  ...
  $query = "SELECT
   P.FIRST_NAME, P.LAST_NAME, SGAME_ID, SUM(PLAYINGTIMEMIN), SUM(PLAYINGTIMESEC), SUM(POINTS), AVG(ASSISTS), AVG(REBOUNDS), AVG(THREE_POINTS), AVG(FTA), AVG(STEAL), AVG(FOUL), AVG(BLOCK), AVG(FTM)
